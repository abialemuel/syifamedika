...
<head>
	...
	<title>Medico - Blog (2 columns)</title>
		...
		<div class="row">
			...
			<div class="large-6 columns">
				<ul class="breadcrumbs right">
					...
					<li><span>Blog (2 Columns)</span></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="large-12 columns">
				<div class="row">
					<div class="large-6 columns">
						<article class="post col-2">
							<div class="post_img">
								<img src="user/images/demo/doctors/1.jpg" alt="post-image">
								<ul class="meta">
									<li><i class="icon-comment"></i>13 comments</li>
									<li><i class="icon-calendar"></i>Mar 09, 2013</li>
								</ul>
							</div>
							<h2>Crave at CES: On the lookout for weird (pictures)</h2>
							<p class="post_text">Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit udin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. </p>
					...
					<div class="large-6 columns">
						<article class="post col-2">
							<div class="post_img">
								<img src="user/images/demo/doctors/2.jpg" alt="post-image">
								<ul class="meta">
									<li><i class="icon-comment"></i>13 comments</li>
									<li><i class="icon-calendar"></i>Mar 09, 2013</li>
								</ul>
							</div>
							<h2>Tumblr's next step: Become a real business</h2>
							<p class="post_text">Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit udin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. </p>
							<a href="#" class="button">Read More</a>
						</article>
					</div>
				...
				<div class="row">
					<div class="large-6 columns">
						<article class="post col-2">
							<div class="post_img">
								<img src="user/images/demo/doctors/3.jpg" alt="post-image">
								<ul class="meta">
									<li><i class="icon-comment"></i>13 comments</li>
									<li><i class="icon-calendar"></i>Mar 09, 2013</li>
								</ul>
					...
					<div class="large-6 columns">
						<article class="post col-2">
							<div class="post_img">
								<img src="user/images/demo/doctors/4.jpg" alt="post-image">
								<ul class="meta">
									<li><i class="icon-comment"></i>13 comments</li>
									<li><i class="icon-calendar"></i>Mar 09, 2013</li>
								</ul>
				...
				<div class="row">
					<div class="large-6 columns">
						<article class="post col-2">
							<div class="post_img">
								<img src="user/images/demo/doctors/5.jpg" alt="post-image">
								<ul class="meta">
									<li><i class="icon-comment"></i>13 comments</li>
									<li><i class="icon-calendar"></i>Mar 09, 2013</li>
								</ul>
					...
					<div class="large-6 columns">
						<article class="post col-2">
							<div class="post_img">
								<img src="user/images/demo/doctors/6.jpg" alt="post-image">
								<ul class="meta">
									<li><i class="icon-comment"></i>13 comments</li>
									<li><i class="icon-calendar"></i>Mar 09, 2013</li>
								</ul>
