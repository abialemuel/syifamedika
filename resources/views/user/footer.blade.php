<footer class="footer_wrapper">
	<div class="row footer-part">
		<div class="large-12 columns">
            ...
            <p>RSU Syifa Medika - Sehat Adalah Berkah</p>
					</div>
				</div>
        ...
        <div class="large-4 columns">
          ...
          <div class="footer_part_content">
            <ul class="about-info">
              <li><i class="icon-home"></i><a href="profilrs"><span>Jl. R.O. Ulin No. 93, Banjarbaru 70712.</span></a></li>
		...
		<div class="footer-part">
			<div class="row">
				<div class="large-10 columns copyright">
					<p>RSU Syifa Medika - Tech Team.</p>
				</div>
