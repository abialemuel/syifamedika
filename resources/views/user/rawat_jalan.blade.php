...
<head>
	...
	<title>Rawat Jalan - RS Syifa Medika</title>
	...
	<div class="main-wrapper">
		<div class="row">
			<div class="large-6 columns">
				<h2>Rawat Jalan - RSU Syifa Medika</h2>
			</div>
			<div class="large-6 columns">
				...
				<div class="row">
					<div class="large-6 columns">
						<article class="post col-2">
							<div class="post_img">
								<img src="user/images/rawatjalan/mata2.jpg" alt="post-image" style="height:350px;">
							</div>
							<h2>Klinik Mata</h2>
							<p class="post_text">Klinik Mata RSU Syifa Medika Banjarbaru ditangani oleh dokter spesialis mata, yaitu:</p>
							<h3>dr. Helen Nguda, Sp.M</h3>
							<h5>Senin – Jum’at</h5>
							<h5>14.00 – 16.00.</h5>
					...
					<div class="large-6 columns">
						<article class="post col-2">
							...
							<div class="row">
								<div class="large-6 columns">
									<h3>drg. Harinda Wahyu Kusumaningtyas</h3>
									<h5>Senin – Jum’at</h5>
									<h5>09.00 – 13.00.</h5>
								</div>
								<div class="large-6 columns">
									<h3>drg. Mario Agung Asmara, Sp.BMM</h3>
									<h5>Senin – Sabtu</h5>
									<h5>18.00 – 20.00.</h5>
								</div>
							</div><br>
							...
							<div class="row">
								<div class="large-4 columns">
									<ul>
										<li>Penambalan Gigi dengan Sinar maupun Non Sinar</li>
										<li>Pencambutan Gigi Susu maupun Gigi Permanen</li>
